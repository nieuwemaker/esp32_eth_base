...
#define FRAME_UPDATE_TIME_UNIT 2 // 50 fps for bandwidth //3 // every 15ms a redraw of the screen = 67 fps (4*5)
...
void loop() {
  ...
  EVERY_N_MILLISECONDS(SINGLE_TIME_UNIT * FRAME_UPDATE_TIME_UNIT){
